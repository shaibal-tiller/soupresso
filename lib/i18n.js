...
export const BN = {
  ...
  'Menu': 'মেনু',
  'This day is locked — only the last': 'এই দিনটি লক করা আছে — শুধু সর্বশেষ',
  'days can be edited here.': 'দিন এখানে সম্পাদনা করা যাবে।',
  ...
  'On day': 'চালু দিন',
  'Off day': 'বন্ধ দিন',
  'Download Sales Report (Excel)': 'বিক্রয় প্রতিবেদন ডাউনলোড (এক্সেল)',
  'Download Sales Report': 'বিক্রয় প্রতিবেদন ডাউনলোড',
  'This Week': 'এই সপ্তাহ',
  'This Month': 'এই মাস',
  'Custom': 'কাস্টম',
  'From': 'থেকে',
  'To': 'পর্যন্ত',
  'Download Excel': 'এক্সেল ডাউনলোড',
  'Failed to generate report.': 'প্রতিবেদন তৈরি করা যায়নি।',
  ...
  'Tomorrow': 'আগামীকাল',
  'Review': 'পর্যালোচনা',
  'Bazar advance': 'বাজারের অগ্রিম',
  'Bhangti': 'ভাংতি',
  "Tomorrow's bazar advance": 'আগামীকালের বাজার অগ্রিম',
  ...
  'Adjustment (+/-)': 'সমন্বয় (+/-)',
  'Total advance given (৳)': 'মোট অগ্রিম দেওয়া (৳)',
  'Meat & Egg': 'মাংস ও ডিম',
  'Vegetables': 'সবজি',
  'Raw Spices': 'কাঁচা মসলা',
  'Processed Spices & Sauces': 'প্রক্রিয়াজাত মসলা ও সস',
  'Cooking Essentials': 'রান্নার উপকরণ',
  'Packaging': 'প্যাকেজিং',
  'Other': 'অন্যান্য',
  'Staff & Home': 'কর্মী ও বাসার খরচ',
  'Categories': 'বিভাগ',
  'Browse categories': 'বিভাগ দেখুন',
  'Item list': 'আইটেম তালিকা',
  'Simple amount': 'সরল পরিমাণ',
  'Close': 'বন্ধ করুন',
  'No items match your search.': 'অনুসন্ধানের সাথে কোনো আইটেম মেলেনি।',
  ...
  'Discard unsaved changes?': 'অসংরক্ষিত পরিবর্তনগুলো বাতিল করবেন?',
  "This entry hasn't been saved yet — leaving now will lose what you've entered.":
    'এই হিসাবটি এখনও সংরক্ষণ করা হয়নি — এখন চলে গেলে আপনার লেখা তথ্য হারিয়ে যাবে।',
  'Keep editing': 'সম্পাদনা চালিয়ে যান',
  'Discard': 'বাতিল করুন',
  'Unsaved draft found for this day': 'এই দিনের একটি অসংরক্ষিত খসড়া পাওয়া গেছে',
  "You have changes here that were never saved — from a previous session that didn't finish.":
    'আগের একটি অসমাপ্ত সেশন থেকে এখানে এমন পরিবর্তন আছে যা কখনো সংরক্ষণ করা হয়নি।',
  'Discard draft': 'খসড়া বাতিল করুন',
  ...
  'Cash Taken Home': 'বাসায় নেওয়া নগদ',
  'Closed by': 'যারা হিসাব বন্ধ করেছেন',
