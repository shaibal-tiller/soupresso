...
export function MenuItemDialog({ item }: { item?: MenuItemData }) {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger render={item ? <Button variant="ghost" size="icon" aria-label="Edit item" /> : <Button />}>
        {item ? (
      ...
      <DialogContent>
        <form action={formAction}>
          <DialogHeader>
            ...
            <DialogDescription>Prices are used only for the Daily Sales item breakdown.</DialogDescription>
          </DialogHeader>
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="grid gap-1.5">
                <Label htmlFor="parcelPrice">Parcel Price (optional)</Label>
